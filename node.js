...
;
	($.$bog_call_menu) = class $bog_call_menu extends ($.$mol_view) {
		title(){
			return (this.$.$mol_locale.text("$bog_call_menu_title"));
		}
		Title(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.title())]);
		...
		lead(){
			return (this.$.$mol_locale.text("$bog_call_menu_lead"));
		}
		Lead(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.lead())]);
		...
		Name_field(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_call_menu_Name_field_hint")));
			(obj.value) = (next) => ((this.name(next)));
			return obj;
		}
		Form(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Name_field())]);
			return obj;
		}
		host_label(){
			return (this.$.$mol_locale.text("$bog_call_menu_host_label"));
		}
		Host_btn(){
			const obj = new this.$.$mol_button_major();
			(obj.click) = (next) => ((this.host_click(next)));
			(obj.sub) = () => ([(this.host_label())]);
			return obj;
		}
		guest_label(){
			return (this.$.$mol_locale.text("$bog_call_menu_guest_label"));
		}
		Guest_btn(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.guest_click(next)));
			(obj.sub) = () => ([(this.guest_label())]);
			return obj;
		}
		Buttons(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Host_btn()), (this.Guest_btn())]);
			return obj;
		}
		hint(){
			return (this.$.$mol_locale.text("$bog_call_menu_hint"));
		}
		Hint(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.hint())]);
	...
	($mol_mem(($.$bog_call_menu.prototype), "Title"));
	($mol_mem(($.$bog_call_menu.prototype), "Lead"));
	($mol_mem(($.$bog_call_menu.prototype), "Name_field"));
	($mol_mem(($.$bog_call_menu.prototype), "Form"));
	($mol_mem(($.$bog_call_menu.prototype), "Host_btn"));
	($mol_mem(($.$bog_call_menu.prototype), "Guest_btn"));
	($mol_mem(($.$bog_call_menu.prototype), "Buttons"));
	($mol_mem(($.$bog_call_menu.prototype), "Hint"));
	($mol_mem(($.$bog_call_menu.prototype), "host_click"));
	($mol_mem(($.$bog_call_menu.prototype), "guest_click"));
	($mol_mem(($.$bog_call_menu.prototype), "name"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_call_menu extends $.$bog_call_menu {
        }
        $$.$bog_call_menu = $bog_call_menu;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_call_qr_show) = class $bog_call_qr_show extends ($.$mol_view) {
		current_frame(){
			return "";
		}
		Frame(){
			const obj = new this.$.$bog_qr();
			(obj.uri) = () => ((this.current_frame()));
	...
	($mol_mem(($.$bog_call_qr_show.prototype), "Frame"));
	($mol_mem(($.$bog_call_qr_show.prototype), "Status"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_call_qr_show extends $.$bog_call_qr_show {
            _timer = null;
            frame_index(next) {
                return next ?? 0;
            }
        ...
        __decorate([
            $mol_mem
        ], $bog_call_qr_show.prototype, "frame_index", null);
        __decorate([
            $mol_mem
        ], $bog_call_qr_show.prototype, "current_frame", null);
        __decorate([
            $mol_mem
        ], $bog_call_qr_show.prototype, "status_text", null);
        $$.$bog_call_qr_show = $bog_call_qr_show;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_call_qr_scan) = class $bog_call_qr_scan extends ($.$mol_view) {
		stream(){
			return null;
		}
		Video(){
			...
			(obj.field) = () => ({"srcObject": (this.stream())});
			return obj;
		}
		hint(){
			return (this.$.$mol_locale.text("$bog_call_qr_scan_hint"));
		}
		Hint(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.hint())]);
		...
		sub(){
			return [(this.Video()), (this.Hint())];
		}
	};
	($mol_mem(($.$bog_call_qr_scan.prototype), "Video"));
	($mol_mem(($.$bog_call_qr_scan.prototype), "Hint"));
	($mol_mem(($.$bog_call_qr_scan.prototype), "on_decode"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_call_qr_scan extends $.$bog_call_qr_scan {
            _loop = null;
            _canvas = null;
            _last_frame = '';
            _last_at = 0;
            ...
            jsqr() {
                if (this.detector())
                    return null;
                const lib = require('jsqr');
                return (lib.default ?? lib);
            }
            Video() {
                const v = super.Video();
                this._ensure_loop(v.dom_node());
                return v;
            }
            _ensure_loop(video) {
                if (this._loop !== null)
            ...
            _on_decoded(text) {
                const now = Date.now();
                if (text === this._last_frame && now - this._last_at < 600)
                    return;
        ...
        __decorate([
            $mol_mem
        ], $bog_call_qr_scan.prototype, "stream", null);
        __decorate([
            $mol_mem
        ], $bog_call_qr_scan.prototype, "detector", null);
        __decorate([
            $mol_mem
        ], $bog_call_qr_scan.prototype, "jsqr", null);
        $$.$bog_call_qr_scan = $bog_call_qr_scan;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_call_host) = class $bog_call_host extends ($.$mol_view) {
		back_label(){
			return (this.$.$mol_locale.text("$bog_call_host_back_label"));
		}
		Back(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.on_back(next)));
			(obj.sub) = () => ([(this.back_label())]);
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$bog_call_host_title"));
		}
		Title(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.title())]);
		...
		Header(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Back()), (this.Title())]);
			return obj;
		}
		Show(){
			const obj = new this.$.$bog_call_qr_show();
			(obj.frames) = () => ((this.frames_share()));
			return obj;
		}
		step_label(){
			return (this.$.$mol_locale.text("$bog_call_host_step_label"));
		}
		Step_label(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.step_label())]);
			return obj;
		}
		Scanner(){
			const obj = new this.$.$bog_call_qr_scan();
			(obj.on_decode) = (next) => ((this.on_scan_decode(next)));
			return obj;
		}
		Status(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.scan_status())]);
			return obj;
		}
		Error(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.scan_error())]);
			return obj;
		}
		manual_label(){
			return (this.$.$mol_locale.text("$bog_call_host_manual_label"));
		}
		Manual_toggle(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.toggle_manual(next)));
			(obj.sub) = () => ([(this.manual_label())]);
			return obj;
		}
		Manual_input(){
			const obj = new this.$.$mol_textarea();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_call_host_Manual_input_hint")));
			(obj.value) = (next) => ((this.manual_text(next)));
			return obj;
		}
		apply_label(){
			return (this.$.$mol_locale.text("$bog_call_host_apply_label"));
		}
		Apply(){
			const obj = new this.$.$mol_button_major();
			(obj.click) = (next) => ((this.apply_manual(next)));
			(obj.sub) = () => ([(this.apply_label())]);
			return obj;
		}
		Manual(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Manual_input()), (this.Apply())]);
			return obj;
		}
		Body(){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$bog_call_host.prototype), "Back"));
	($mol_mem(($.$bog_call_host.prototype), "Title"));
	($mol_mem(($.$bog_call_host.prototype), "Header"));
	($mol_mem(($.$bog_call_host.prototype), "Show"));
	($mol_mem(($.$bog_call_host.prototype), "Step_label"));
	($mol_mem(($.$bog_call_host.prototype), "Scanner"));
	($mol_mem(($.$bog_call_host.prototype), "Status"));
	($mol_mem(($.$bog_call_host.prototype), "Error"));
	($mol_mem(($.$bog_call_host.prototype), "Manual_toggle"));
	($mol_mem(($.$bog_call_host.prototype), "Manual_input"));
	($mol_mem(($.$bog_call_host.prototype), "Apply"));
	($mol_mem(($.$bog_call_host.prototype), "Manual"));
	($mol_mem(($.$bog_call_host.prototype), "Body"));
	($mol_mem(($.$bog_call_host.prototype), "on_back"));
	($mol_mem(($.$bog_call_host.prototype), "on_connected"));
	($mol_mem(($.$bog_call_host.prototype), "manual_visible"));
	($mol_mem(($.$bog_call_host.prototype), "manual_text"));
	($mol_mem(($.$bog_call_host.prototype), "toggle_manual"));
	($mol_mem(($.$bog_call_host.prototype), "apply_manual"));
	($mol_mem(($.$bog_call_host.prototype), "on_scan_decode"));
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $bog_call_peer.prototype, "state", null);
    __decorate([
        $mol_mem
    ], $bog_call_peer.prototype, "connection_state", null);
    __decorate([
        $mol_mem
    ], $bog_call_peer.prototype, "ice_state", null);
    __decorate([
        $mol_mem
    ], $bog_call_peer.prototype, "muted", null);
    __decorate([
        $mol_mem
    ], $bog_call_peer.prototype, "quality", null);
    __decorate([
        $mol_mem
    ], $bog_call_peer.prototype, "error", null);
    $.$bog_call_peer = $bog_call_peer;
})($ || ($ = {}));
...
(function ($) {
    ...
    class $bog_call_peer_record extends $giper_baza_entity.with({
        Device: $giper_baza_atom_text,
        Last: $giper_baza_atom_time,
    }) {
    }
    $.$bog_call_peer_record = $bog_call_peer_record;
    /** Local profile + recent peers, kept in home land */
    class $bog_call_profile extends $giper_baza_entity.with({
        Device: $giper_baza_atom_text,
        Recent: $giper_baza_list_link_to(() => $bog_call_peer_record),
    }) {
    }
    $.$bog_call_profile = $bog_call_profile;
    class $bog_call_store extends $mol_object {
        glob() {
        ...
        profile() {
            return this.home_land().Data($bog_call_profile);
        }
        device_id() {
        ...
        remember(device, name) {
            ...
            if (!recent)
                return;
            const items = recent.remote_list();
            ...
            const rec = recent.make([[null, $giper_baza_rank_post('just')]]);
            if (!rec)
                return;
    ...
    $.$bog_call_store = $bog_call_store;
    function $bog_call_random_id() {
        const buf = new Uint8Array(8);
        crypto.getRandomValues(buf);
        return Array.from(buf, b => b.toString(16).padStart(2, '0')).join('');
    }
    $.$bog_call_random_id = $bog_call_random_id;
})($ || ($ = {}));
...
(function ($) {
    ...
    class $bog_call_codec extends $mol_object2 {
        ...
        static filter_sdp(sdp) {
            const lines = sdp.split(/\r?\n/);
            const out = [];
            for (const line of lines) {
                if (!line)
                    continue;
                if (line.startsWith('a=candidate:') && !/typ host/.test(line))
                    continue;
                out.push(line);
            }
            return out.join('\r\n') + '\r\n';
        }
        static b64u_encode(bytes) {
            let s = '';
    ...
    (function ($$) {
        class $bog_call_host extends $.$bog_call_host {
            ...
            frames_share() {
                ...
                if (!peer || !store)
                    return [];
                const sdp = $mol_wire_sync(peer).create_offer();
        ...
        __decorate([
            $mol_mem
        ], $bog_call_host.prototype, "manual_visible", null);
        __decorate([
            $mol_mem
        ], $bog_call_host.prototype, "manual_text", null);
        __decorate([
            $mol_mem
        ], $bog_call_host.prototype, "ingested_count", null);
        __decorate([
            $mol_mem
        ], $bog_call_host.prototype, "total_frames", null);
        __decorate([
            $mol_mem
        ], $bog_call_host.prototype, "frames_share", null);
        __decorate([
            $mol_mem
        ], $bog_call_host.prototype, "scan_status", null);
        __decorate([
            $mol_mem
        ], $bog_call_host.prototype, "scan_error", null);
        $$.$bog_call_host = $bog_call_host;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_call_guest) = class $bog_call_guest extends ($.$mol_view) {
		back_label(){
			return (this.$.$mol_locale.text("$bog_call_guest_back_label"));
		}
		Back(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.on_back(next)));
		...
		title(){
			return (this.$.$mol_locale.text("$bog_call_guest_title"));
		}
		Title(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.title())]);
		...
		step_a(){
			return (this.$.$mol_locale.text("$bog_call_guest_step_a"));
		}
		Step_a(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.step_a())]);
		...
		manual_label(){
			return (this.$.$mol_locale.text("$bog_call_guest_manual_label"));
		}
		Manual_toggle(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.toggle_manual(next)));
		...
		Manual_input(){
			const obj = new this.$.$mol_textarea();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_call_guest_Manual_input_hint")));
			(obj.value) = (next) => ((this.manual_text(next)));
			return obj;
		}
		apply_label(){
			return (this.$.$mol_locale.text("$bog_call_guest_apply_label"));
		}
		Apply(){
			const obj = new this.$.$mol_button_major();
			(obj.click) = (next) => ((this.apply_manual(next)));
		...
		step_b(){
			return (this.$.$mol_locale.text("$bog_call_guest_step_b"));
		}
		Step_b(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.step_b())]);
		...
		Show(){
			const obj = new this.$.$bog_call_qr_show();
			(obj.frames) = () => ((this.frames_answer()));
			return obj;
		}
		Share_block(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Step_b()), (this.Show())]);
			return obj;
		}
		peer(){
			return null;
	...
	($mol_mem(($.$bog_call_guest.prototype), "Back"));
	($mol_mem(($.$bog_call_guest.prototype), "Title"));
	($mol_mem(($.$bog_call_guest.prototype), "Header"));
	($mol_mem(($.$bog_call_guest.prototype), "Body"));
	($mol_mem(($.$bog_call_guest.prototype), "Step_a"));
	($mol_mem(($.$bog_call_guest.prototype), "Scanner"));
	($mol_mem(($.$bog_call_guest.prototype), "Status"));
	($mol_mem(($.$bog_call_guest.prototype), "Error"));
	($mol_mem(($.$bog_call_guest.prototype), "Manual_toggle"));
	($mol_mem(($.$bog_call_guest.prototype), "Manual_input"));
	($mol_mem(($.$bog_call_guest.prototype), "Apply"));
	($mol_mem(($.$bog_call_guest.prototype), "Manual"));
	($mol_mem(($.$bog_call_guest.prototype), "Scan_block"));
	($mol_mem(($.$bog_call_guest.prototype), "Step_b"));
	($mol_mem(($.$bog_call_guest.prototype), "Show"));
	($mol_mem(($.$bog_call_guest.prototype), "Share_block"));
	($mol_mem(($.$bog_call_guest.prototype), "on_back"));
	($mol_mem(($.$bog_call_guest.prototype), "on_connected"));
	($mol_mem(($.$bog_call_guest.prototype), "manual_visible"));
	($mol_mem(($.$bog_call_guest.prototype), "manual_text"));
	($mol_mem(($.$bog_call_guest.prototype), "toggle_manual"));
	($mol_mem(($.$bog_call_guest.prototype), "apply_manual"));
	($mol_mem(($.$bog_call_guest.prototype), "on_scan_decode"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_call_guest extends $.$bog_call_guest {
            ...
            body_sub() {
                if (this.answer_ready())
                    return [this.Share_block()];
            ...
            build_answer() {
                ...
                try {
                    ...
                    const sdp = $mol_wire_sync(peer).accept_offer(offer.s);
        ...
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "manual_visible", null);
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "manual_text", null);
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "ingested_count", null);
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "total_frames", null);
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "answer_ready", null);
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "frames_answer", null);
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "scan_status", null);
        __decorate([
            $mol_mem
        ], $bog_call_guest.prototype, "scan_error", null);
        $$.$bog_call_guest = $bog_call_guest;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_call_active) = class $bog_call_active extends ($.$mol_view) {
		wake(){
			return null;
		}
		quality(){
		...
		Indicator(){
			const obj = new this.$.$mol_view();
			(obj.attr) = () => ({...(this.$.$mol_view.prototype.attr.call(obj)), "quality": (this.quality())});
			(obj.sub) = () => ([(this.indicator_label())]);
			return obj;
		}
		Status(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.connection_label())]);
			return obj;
		}
		Quality(){
			const obj = new this.$.$mol_view();
		...
		hangup_label(){
			return (this.$.$mol_locale.text("$bog_call_active_hangup_label"));
		}
		Hangup(){
			const obj = new this.$.$mol_button_major();
			(obj.click) = (next) => ((this.hangup(next)));
			(obj.sub) = () => ([(this.hangup_label())]);
			return obj;
		}
		peer(){
			return null;
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_call_active.prototype, "mute", null);
        __decorate([
            $mol_mem
        ], $bog_call_active.prototype, "quality", null);
        __decorate([
            $mol_mem
        ], $bog_call_active.prototype, "connection_label", null);
        __decorate([
            $mol_mem
        ...
        $$.$bog_call_active = $bog_call_active;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_call_app) = class $bog_call_app extends ($.$mol_page) {
		Sources(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/bog/call");
			return obj;
		}
		Status(){
		...
		title(){
			return (this.$.$mol_locale.text("$bog_call_app_title"));
		}
		name(next){
			if(next !== undefined) return next;
			return "";
		...
		Menu(){
			const obj = new this.$.$bog_call_menu();
			(obj.name) = (next) => ((this.name(next)));
			(obj.host_click) = (next) => ((this.open_host(next)));
			(obj.guest_click) = (next) => ((this.open_guest(next)));
			return obj;
		}
		Host(){
			const obj = new this.$.$bog_call_host();
			(obj.peer) = () => ((this.peer()));
			(obj.store) = () => ((this.store()));
			(obj.on_back) = (next) => ((this.goto_home(next)));
			(obj.on_connected) = (next) => ((this.goto_active(next)));
			return obj;
		}
		Guest(){
			const obj = new this.$.$bog_call_guest();
			(obj.peer) = () => ((this.peer()));
			(obj.store) = () => ((this.store()));
			(obj.on_back) = (next) => ((this.goto_home(next)));
			(obj.on_connected) = (next) => ((this.goto_active(next)));
		...
		Active(){
			const obj = new this.$.$bog_call_active();
			(obj.peer) = () => ((this.peer()));
			(obj.on_hangup) = (next) => ((this.goto_home(next)));
			return obj;
		}
	};
	($mol_mem(($.$bog_call_app.prototype), "Sources"));
	($mol_mem(($.$bog_call_app.prototype), "Status"));
	($mol_mem(($.$bog_call_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_call_app.prototype), "Theme"));
	($mol_mem(($.$bog_call_app.prototype), "open_host"));
	($mol_mem(($.$bog_call_app.prototype), "open_guest"));
	($mol_mem(($.$bog_call_app.prototype), "goto_home"));
	($mol_mem(($.$bog_call_app.prototype), "goto_active"));
	($mol_mem(($.$bog_call_app.prototype), "name"));
	($mol_mem(($.$bog_call_app.prototype), "Menu"));
	($mol_mem(($.$bog_call_app.prototype), "Host"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_call_app.prototype, "screen", null);
        __decorate([
            $mol_mem
        ], $bog_call_app.prototype, "store", null);
        __decorate([
            $mol_mem
        ], $bog_call_app.prototype, "name", null);
        __decorate([
            $mol_mem
        ], $bog_call_app.prototype, "screen_body", null);
        $$.$bog_call_app = $bog_call_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
